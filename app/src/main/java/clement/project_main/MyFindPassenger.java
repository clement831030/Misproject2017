...
public class MyFindPassenger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.myfindpassenger);
        ...
        chat = FirebaseDatabase.getInstance().getReference().child("FindDriver").child(key).child("chat");

        ref.child("FindDriver").child(key).child("currentnum").child("user1").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (user1!=null) {
                    ...
                    Picasso.with(MyFindPassenger.this).load(Image1).into(imUser1);
        ...
        ref.child("FindDriver").child(key).child("currentnum").child("user2").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue(Post.class) != null) {
                    post = dataSnapshot.getValue(Post.class);
                ...
                if (user2!=null) {
                    ...
                    Picasso.with(MyFindPassenger.this).load(Image2).into(imUser2);
        ...
        ref.child("FindDriver").child(key).child("currentnum").child("user3").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue(Post.class) != null) {
                    post = dataSnapshot.getValue(Post.class);
                ...
                if (user3!=null) {
                    ...
                    Picasso.with(MyFindPassenger.this).load(Image3).into(imUser3);
        ...
        //populateMsgList();
        //populateListView();
        //setListViewHeightBasedOnChildren(listView_lv );
        ...
        UserPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myuserName0 != null) {
                    AlertDialog.Builder UserPic = new AlertDialog.Builder(MyFindPassenger.this);
        ...
        imUser1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myuserName1 != null) {
                    AlertDialog.Builder imUser1 = new AlertDialog.Builder(MyFindPassenger.this);
        ...
        imUser2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myuserName2 != null) {
                    AlertDialog.Builder imUser2 = new AlertDialog.Builder(MyFindPassenger.this);
        ...
        imUser3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (myuserName3 !=null) {
                    AlertDialog.Builder imUser3 = new AlertDialog.Builder(MyFindPassenger.this);
    ...
    public void onCloseClick(View view) {
        ...
        Intent intent = new Intent(MyFindPassenger.this,MainActivity.class);
    ...
    public void onSendClick(View view) {
        ...
        imm.hideSoftInputFromWindow(MyFindPassenger.this.getCurrentFocus().getWindowToken(),InputMethodManager.HIDE_NOT_ALWAYS);
    }
    ...
    private void showResults() {
        ...
        price_tv.setText("價錢：  "+ price + "元");
        vehicle_tv.setText("交通方式：  "+ vehicle);
        ...
        Picasso.with(MyFindPassenger.this).load(Uri).into(UserPic);
    ...
    private void addData1() {
        ...
        Map.put("Image",uri);
        Map.put("name",name);
        ref.child("FindDriver").child(key).child("currentnum").child("user1").updateChildren(Map);
        user1_name.setText(name);
        Picasso.with(MyFindPassenger.this).load(uri).into(imUser1);
    ...
    private void addData2() {
        ...
        Map.put("Image",uri);
        Map.put("name",name);
        ref.child("FindDriver").child(key).child("currentnum").child("user2").updateChildren(Map);
        user2_name.setText(name);
        Picasso.with(MyFindPassenger.this).load(uri).into(imUser2);
    ...
    private void addData3() {
        ...
        Map.put("Image",uri);
        Map.put("name",name);
        ref.child("FindDriver").child(key).child("currentnum").child("user3").updateChildren(Map);
        user3_name.setText(name);
        Picasso.with(MyFindPassenger.this).load(uri).into(imUser3);
    }
