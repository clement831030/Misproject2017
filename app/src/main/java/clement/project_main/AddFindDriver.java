...
public class AddFindDriver extends AppCompatActivity {

    //宣告元件
    private Toolbar toolBar;
    private ImageView background_iv;
    private ImageButton send_ib, delete_ib;
    private EditText from_et, to_et,price_et,note_et;
    private TextView date_tv, time_tv;
    private Spinner people_sp;
    private RadioButton car_rb,motor_rb,both_rb;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addfinddriver);
        initView();
        setDate();
        setTime();
        setToolBar();

        people_adapter = new ArrayAdapter<String>(this, R.layout.spinner_item,new String[]{"1","2","3","4","5","6"});
        ...
        vehicle_rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (car_rb.getId() == checkedId) {
                    vehicle = "汽車";
                } else if (motor_rb.getId() == checkedId) {
                    vehicle = "機車";
                }else if(both_rb.getId()==checkedId) {
                    vehicle = "皆可";
                }
            }
        });
    ...
    private void initView() {
        ...
        both_rb = (RadioButton)findViewById(R.id.both_rb);
    ...
    private void setDate(){
        date_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(AddFindDriver.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        TextView date_tv = (TextView) AddFindDriver.this.findViewById(R.id.date_tv);
    ...
    private void setTime(){
        time_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog dialog = new TimePickerDialog(AddFindDriver.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hour, int minute){
                        TextView time_tv = (TextView) AddFindDriver.this.findViewById(R.id.time_tv);

                        if (mYear == now_year && mMonth == now_month && mDay==now_day) {
                            if(mHour < now_hour){
                                Toast.makeText(AddFindDriver.this, "請輸入未來時間", Toast.LENGTH_SHORT).show();
                            }
    ...
    private Spinner.OnItemSelectedListener peopleListener= new Spinner.OnItemSelectedListener()
    {
        ...
        {
            Toast.makeText(AddFindDriver.this, "請選擇人數", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public void onSendClick(View view) {
        ...
        /*
        Intent intent = new Intent(this,MyFindDriver.class);          //new一個intent物件，指定Activity切換到MyFindDriver
        Bundle bundle = new Bundle();                                //new一個Bundle物件，將要傳遞的資料傳入
        bundle.putString("from_key", from_et.getText().toString());  //參數依序代表(KEY,value)
        ...
        startActivity(intent);                                      //切換到ShowDetail Activity
        */
        Intent intent = new Intent(AddFindDriver.this,MainActivity.class);
        startActivity(intent);
    }

    // 按下delete_ib跳出AlertDialog詢問
    private AlertDialog onDeleteClicked(String message){
        AlertDialog.Builder builder = new AlertDialog.Builder(AddFindDriver.this);    //產生一個Builder物件
    ...
    private void addData(String from,String to,String date,String time,String people,String note,String price,String vehicle) {
        ...
        String key = mDatabase.child("FindDriver").push().getKey();
        Post Post=new Post();
        ...
        mDatabase.child("FindDriver").child(key).updateChildren(Map);
