...
public class AddCallTaxi extends AppCompatActivity {

    //宣告元件
    private Toolbar toolBar;
    private ImageView background_iv;
    private ImageButton send_ib, delete_ib;
    private EditText from_et, to_et, note_et;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addcalltaxi);
        initView();
        setDate();
        setTime();
        setToolBar();
    ...
    private void setDate(){
        date_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(AddCallTaxi.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void setTime(){
        time_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog dialog = new TimePickerDialog(AddCallTaxi.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hour, int minute){
                        TextView time_tv = (TextView) AddCallTaxi.this.findViewById(R.id.time_tv);

                        if (mYear == now_year && mMonth == now_month && mDay==now_day) {
                            if(mHour < now_hour){
                                Toast.makeText(AddCallTaxi.this, "請輸入未來時間", Toast.LENGTH_SHORT).show();
                            }
    ...
    private Spinner.OnItemSelectedListener peopleListener= new Spinner.OnItemSelectedListener()
    {
        ...
        {
            Toast.makeText(AddCallTaxi.this, "請選擇人數", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public void onSendClick(View view) {
        ...
        boolean allValid = FromIsValid(from_et) & ToIsValid(to_et) & timeIsValid(time_tv) & dateIsValid(date_tv) & people != null;
        if (!allValid) {return;}                    //如果沒有全部通過驗證就返回

        addData(from_et.getText().toString(), to_et.getText().toString(), date_tv.getText().toString(), time_tv.getText().toString(), people,note_et.getText().toString());
        /*
        Intent intent = new Intent(this,MyCallTaxi.class);          //new一個intent物件，指定Activity切換到MyCallTaxi
        ...
        */
        Intent intent = new Intent(AddCallTaxi.this,MainActivity.class);
        startActivity(intent);
    }

    // 按下delete_ib跳出AlertDialog詢問
    private AlertDialog onDeleteClicked(String message){
        AlertDialog.Builder builder = new AlertDialog.Builder(AddCallTaxi.this);  //產生一個Builder物件
    ...
    private void addData(String from,String to,String date,String time,String people,String note) {
        DatabaseReference mDatabase;
        mDatabase = FirebaseDatabase.getInstance().getReference();
        FirebaseUser u = FirebaseAuth.getInstance().getCurrentUser();
        ...
        String key = mDatabase.child("CallTaxi").push().getKey();
        Post Post=new Post();
        ...
        mDatabase.child("CallTaxi").child(key).updateChildren(Map);
